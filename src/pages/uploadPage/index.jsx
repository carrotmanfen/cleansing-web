                    ...
                    <div className='w-[430px]'>
                        ...
                        <div className='text-[16px] font-kanit mt-8 '>
                            <div className='flex flex-row justify-center items-center'>
                                <p className='text-center text-textPrimary text-[20px]'>อัปโหลดไฟล์ของคุณโดยที่</p>
                                <div onClick={()=>window.open(process.env.NEXT_PUBLIC_WEB_SERVICE_URL+"manual#section-four", '_blank')} className='w-[30px] h-[30px] pl-2 hover:cursor-pointer'>
