  ...
  return (
    <div className="relative w-screen h-full">
      ...
      <div className="w-full flex flex-col items-center pb-20 ">
        ...
        <p className="text-[32px] text-textPrimary font-kanit mt-2">
          สมัครสมาชิก
        </p>
        ...
        <div className="flex">
          ...
          <Link
            href={"/login"}
            className="text-primary hover:text-hoverPrimary underline flex "
          >
            เข้าสู่ระบบ
          </Link>
        </div>
          <div className="flex flex-row w-full justify-between">
            <Link href={"/"}>
              <button className="px-16 py-2 mt-8 bg-gray hover:bg-textGray rounded-2xl">
                ยกเลิก
              </button>
            </Link>
            <button
              onClick={handleRegister}
              className="px-16 py-2 mt-8 bg-primary hover:bg-hoverPrimary rounded-2xl text-white"
            >
              ยืนยัน
            </button>
          </div>
